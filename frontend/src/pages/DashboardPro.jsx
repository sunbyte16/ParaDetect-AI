  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <button
        ...
        className="fixed bottom-8 right-8 w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all transform hover:scale-110 flex items-center justify-center z-40 animate-pulse"
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2 text-blue-600 bg-blue-50 rounded-lg font-medium hover:bg-blue-100 transition-all"
              >
                📊 Dashboard
              </button>
              <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-semibold text-red-600 bg-red-50 px-3 py-1 rounded-full">Alert</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-semibold text-green-600 bg-green-50 px-3 py-1 rounded-full">Healthy</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
              ...
              <div className="text-3xl font-bold text-purple-600 mb-1">{stats.total_patients}</div>
      ...
      <main className="container mx-auto px-4 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="mb-8 p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border border-blue-100">
                ...
                <div className="flex gap-3">
                  <select
                    ...
                    className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                  >
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all font-semibold shadow-md"
                  >
                    + New
                  </button>
                </div>
              ...
              <div className="flex gap-4 mt-6">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-blue-500 to-purple-500 text-white py-4 px-8 rounded-xl font-bold text-lg disabled:opacity-50 transition-all hover:shadow-xl transform hover:scale-105 disabled:transform-none flex items-center justify-center gap-3"
                >
                  {loading ? (
                    <>
                ...
                <button
                  onClick={handleReset}
                  disabled={loading}
                  className="px-8 py-4 bg-gray-500 text-white rounded-xl font-bold hover:bg-gray-600 transition-all"
                >
                  🔄 Reset
                </button>
              </div>
              ...
              {showSuccess && !loading && result && (
                <div className="mt-6 p-5 bg-green-50 border-2 border-green-200 rounded-xl flex items-center gap-3 animate-pulse">
                  <span className="text-3xl">✅</span>
          ...
          <div className="space-y-8">
            {/* Results */}
            <div id="results" className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <button
                onClick={() => navigate('/history')}
                className="mt-4 w-full px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-all font-semibold"
              >
                View All History →
              </button>
            </div>
